...
title: Eastercup
id: eastercup
ghLink: https://github.com/Marty-W/eastercup
siteLink: https://eastercupklatovy.cz
description: User-facing website and internal tool for international basketball tournament.
coverImage: ./eastercup_cover.png
longDescription: Website and internal tool for annual international basketball tournament in Klatovy written in Typescript and with Next.js.
images:
  [
    { src: ./images/eastercup/landing.png, description: "Landing page" },
    { src: ./images/eastercup/results.png, description: "Team results" },
    {
      src: ./images/eastercup/responsive.png,
      description: "The app is fully responsive.",
    },
    {
      src: ./images/eastercup/internal_tool.png,
      description: "Tournament's admin dashboard.",
    },
    { src: ./images/eastercup/standings.png, description: "Group standings." },
    { src: ./images/eastercup/info.png, description: "Info page" },
  ]
---
...
- implement own backend and ditch uiBakery
