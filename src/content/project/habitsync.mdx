...
images:
  [
    { src: ./images/habitsync/landing.webp, description: "Landing page" },
    { src: ./images/habitsync/dashboard.webp, description: "Habit dashboard" },
    { src: ./images/habitsync/features_1.png, description: "Main features" },
    {
      src: ./images/habitsync/features_3.png,
      description: "Todoist integration",
    },
    {
      src: ./images/habitsync/responsive.png,
      description: "The app is built both for desktop and mobile.",
    },
    { src: ./images/habitsync/dark.webp, description: "Dark mode" },
  ]
---
